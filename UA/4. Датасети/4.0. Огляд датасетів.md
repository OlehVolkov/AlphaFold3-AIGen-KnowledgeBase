...
flowchart TD
    ...
    CASP["CASP<br/>blind benchmark задачі"]:::conf

    MSA["Побудова MSA<br/>HHblits / Jackhmmer / MMseqs2"]:::proc
    TRAIN["Навчання моделі<br/>AF2 / AF3"]:::trunk
    EVAL["Сліпа оцінка<br/>CASP / CAMEO"]:::conf

    AFDB["AlphaFoldDB<br/>200M передбачених структур"]:::out
    SCREEN["Скринінг протеомів<br/>пошук ліків / анотація"]:::out
