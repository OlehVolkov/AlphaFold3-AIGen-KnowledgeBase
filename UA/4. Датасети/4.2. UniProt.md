...
flowchart LR
    ...
    AUTO["Автоматична анотація<br/>пайплайн"]:::proc
    TREMBL["TrEMBL<br/>250M записів<br/>низька впевненість"]:::diff
    MANUAL["Ручна курація<br/>експертами"]:::trunk
    SPROT["Swiss-Prot<br/>570K записів<br/>висока впевненість"]:::out
