...
- `AGENTS.md` та `AGENTS.md` синхронізовано з актуальними правилами Mermaid.
...
- Повторно перевірено структуру vault проти `AGENTS.md` / `AGENTS.md`.
...
- Проведено ревізію списків літератури `UA/Література та пріоритети.md` та `Literature and Priorities.md`.
...
- Оновлено `AGENTS.md` та `AGENTS.md`: додано окремий розділ про `AUDIT.md`.
...
- Оновлено `AGENTS.md` та `AGENTS.md`:
