...
```mermaid
flowchart TD
    T["Transformer<br/>(Vaswani 2017)"]:::base
    BI["BERT-like<br/>(MLM pretraining)"]:::nlp
    ESM["ESM-2<br/>(білкові послідовності)"]:::bio
    AF2["AlphaFold2<br/>Evoformer"]:::af
    AF3["AlphaFold3<br/>Pairformer<br/>(без MSA stack)"]:::af3
    IPA["IPA<br/>(Invariant Point<br/>Attention)"]:::geom
