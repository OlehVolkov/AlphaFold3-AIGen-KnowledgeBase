...
flowchart TD
    ...
    FNAT["f_nat\nЧастка нативних\nконтактів збережена"]:::comp
    IRMSD["iRMSD\nRMSD атомів\nна інтерфейсі"]:::comp
    LRMSD["LRMSD\nRMSD ліганду після\nсуміщення рецептора"]:::comp

    DQ --> FNAT & IRMSD & LRMSD

    F1["Контакт: два С_β\nна відстані < 5 Å\n(або C_α для Gly)"]:::note
    I1["Інтерфейс: залишки\nрецептора < 10 Å\nвід ліганду"]:::note
    L1["RMSD ланцюга-ліганду\nпісля суміщення\nрецептора (backbone)"]:::note
...
- [[UA/02_Концепції/Біологія/Ліганди та малі молекули]]
