...
flowchart LR
    ...
    AUTO["Automated annotation<br/>pipeline"]:::neutral
    TREMBL["TrEMBL<br/>250M entries<br/>low confidence"]:::diffusion
    MANUAL["Manual expert<br/>curation"]:::trunk
    SPROT["Swiss-Prot<br/>570K entries<br/>high confidence"]:::output
