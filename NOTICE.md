...
Останнє оновлення: 2026-03-07 (оновлено)
...
## 8. Масштабування діаграм та ілюстрацій

- Використовуємо `.obsidian/snippets/diagram-scale.css`.
- Ціль: Mermaid та Excalidraw мають іти на ширину текстового контейнера (`100%`), без мікро-тексту.
